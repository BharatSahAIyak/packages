...
var fusionAuth = new import_typescript_client.FusionAuthClient("bf69486b-4733-4470-a592-f1bfce7af580", "https://local.fusionauth.io");
...
async function optInUser(xMsg, usernameHSM, passwordHSM, username2Way, password2Way) {
  ...
  try {
    const response = await import_axios2.default.get(expanded);
...
var _GSWhatsappService = class _GSWhatsappService {
  constructor() {
    this.webClient = import_axios2.default.create();
  }
  static getInstance() {
